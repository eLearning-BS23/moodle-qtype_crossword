 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_crossword_question extends question_graded_automatically_with_countback {
...
//                        get_string('deletedsubquestion', 'qtype_crossword'), 'notifyproblem');
...
//                $this->choices[$choiceid] = get_string('deletedchoice', 'qtype_crossword');
//            }
//        }
//    }
